    ...
    public void onBlockBreak(BlockBreakEvent e) {
        try {
            ...
            if (level != 0) {
                ...
                if (instance.getConfig().getBoolean("Main.Remember Furnace Item Levels"))
                    itemmeta.setDisplayName(Methods.formatText(Methods.formatName(level, furnace.getUses(), true)));
